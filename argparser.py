...
def get_argparser():
    ...
    parser.add_argument("--memory_mixup", action='store_true', default=False,
                        help="memory the particular feature from base data according to prototypes")
    ...
    parser.add_argument("--EMA", default=False, action="store_true",
                        help="Using EMA in knowledge distillation")
    ...
    parser.add_argument("--embedding_loss", default=0, type=float)
    parser.add_argument("--distill_interval", default=1000, type=int)
    
    # contrast Loss
    parser.add_argument("--contrast_loss", default=0, type=float)
